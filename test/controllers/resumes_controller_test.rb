...
class ResumesControllerTest < ActionController::TestCase
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post :create, resume: { artists: @resume.artists, curator: @resume.curator, link: @resume.link, location: @resume.location, text: @resume.text, title: @resume.title, year: @resume.year }
    end
  ...
  test "should update resume" do
    patch :update, id: @resume, resume: { artists: @resume.artists, curator: @resume.curator, link: @resume.link, location: @resume.location, text: @resume.text, title: @resume.title, year: @resume.year }
    assert_redirected_to resume_path(assigns(:resume))
  end
